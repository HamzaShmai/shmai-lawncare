            ...
            <div className="col-lg-6">
              ...
              <div className="skill-content-box mb-35 wow fadeInLeft">
                ...
                <p className="mb-30">
                  ...
                  include professional service, quality materials, and a satisfaction guarantee.
                </p>
                {/*====== Skills List ======*/}
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              ...
              <div className="cta-content-box text-white mb-50 wow fadeInLeft">
                ...
                <p className="mb-30">
                  Connect with our certified gardening experts who bring decades of experience and
                  proven results to transform your outdoor space beautifully.
                </p>
