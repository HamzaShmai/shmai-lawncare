                    ...
                    <div className="col-md-6">
                      <div className="fancy-icon-box-two mb-30 wow fadeInUp">
                        ...
                        <div className="text">
                          ...
                          <p>
                            We create beautiful, sustainable gardens that inspire peace and joy daily.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="fancy-icon-box-two mb-30 wow fadeInDown">
                        ...
                        <div className="text">
                          ...
                          <p>
                            We organize engaging community events and educational gardening programs year-round.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="fancy-icon-box-two mb-30 wow fadeInUp">
                        ...
                        <div className="text">
                          ...
                          <p>
                            Regular lawn care, pruning, seasonal cleanup, and complete garden upkeep services.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="fancy-icon-box-two mb-30 wow fadeInDown">
                        ...
                        <div className="text">
                          ...
                          <p>
                            Innovative urban gardening solutions for small spaces and city environments.
                          </p>
                        </div>
                      </div>
                    </div>
